...
* Level 5 The **Lost Soul** marks the Vessel with \[shimmering tattoo] on \[his chest over his heart] that allows the Vessel to \[Channel the Ward's Power] and \[makes him vulnerable to intrusive thoughts].
...
1. Level 4 **Reliquary Necklace** is chain container that \[holds special vials of essence]. -- can contain 4 vials
	1. Level 6 **The Guardian Vial** is a vexed vial that \[Contains the Echo of **Chase Knight**].
	2. Level 10 **The Verdant Vial** is a living terrarium that \[soothes the environmental impact through symbiosis of the Verdant Hush].
...
4. Level 1 **Ritual Kit** is a compact container that \[is filled with all the ritual needs] -- can contain 3 medium things
	1. Level 3 **Binding Ink** \[depletion] (small)
	2. Quill and Regular Ink
...
**The Home Archive**
* **Binding Ink** is a homemade ritual ink that \[stabilizes Vas blood to permanently capture a creature in a vessel]. \[depletion] -- qty: 0

**Spells**
* Level 4 **Bind Creature** is binding chaos spell that \[permanently a creature to a Vessel]. (+1 for every level the creature is over 3) -- Requires the True Name 
* Level 3 **Transfer Creature** is binding chaos spell that \[transfers a creature to a Vessel]. (+1 for every level the creature is over 3)
